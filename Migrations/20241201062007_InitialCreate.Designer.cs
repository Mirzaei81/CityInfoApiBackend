...
namespace CityInfoApi.Migrations
{
    ...
    [Migration("20241201062007_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CityInfoApi.Models.Bar1", b =>
                {
                    ...
                    b.Property<int?>("BNumKoli")
                        .HasColumnType("int")
                        .HasColumnName("B_NumKoli");

                    b.Property<int?>("BPrsn")
                        .HasColumnType("int")
                        .HasColumnName("B_Prsn");

                    b.Property<int?>("BSanad")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CityInfoApi.Models.Check", b =>
                {
                    ...
                    b.Property<int?>("CRadif")
                        .HasColumnType("int")
                        .HasColumnName("C_Radif");

                    b.Property<int?>("CSanad")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CityInfoApi.Models.Factor1", b =>
                {
                    ...
                    b.Property<int?>("FPorsant")
                        .HasColumnType("int")
                        .HasColumnName("F_Porsant");

                    b.Property<int?>("FPrint")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("F_Print")
                        .HasDefaultValueSql("(0)");

                    b.Property<int?>("FSanad")
                        .HasColumnType("int")
                        .HasColumnName("F_Sanad");

                    b.Property<int?>("FSerial")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CityInfoApi.Models.Ins2Factor", b =>
                {
                    b.Property<int>("RowsAffected")
                        .HasColumnType("int");

                    b.ToTable("Ins2factor");
                });
            ...
            modelBuilder.Entity("CityInfoApi.Models.Payment1", b =>
                {
                    ...
                    b.Property<int?>("P1Moshtari")
                        .HasColumnType("int")
                        .HasColumnName("P1_Moshtari");

                    b.Property<int?>("P1Sanad")
                        .HasColumnType("int")
