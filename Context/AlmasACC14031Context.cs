...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Check>(entity =>
            {
                ...
                entity.Property(e => e.CSayadi)
                    .HasMaxLength(50)
                    .HasColumnName("C_Sayadi");
            ...
            modelBuilder.Entity<Kala>(entity =>
            {
                ...
                entity.Property(e => e.KMali)
                    .HasMaxLength(20)
                    .HasColumnName("K_Mali")
                    .UseCollation("Arabic_CI_AI");
            ...
            modelBuilder.Entity<Moshtari>(entity =>
            {
                ...
                entity.Property(e => e.MShobe)
                    .HasMaxLength(50)
                    .HasColumnName("M_Shobe");
            ...
            modelBuilder.Entity<Vahed>(entity =>
            {
                ...
                entity.Property(e => e.VMali)
                    .HasMaxLength(20)
                    .HasColumnName("V_Mali")
                    .UseCollation("Arabic_CI_AI");
